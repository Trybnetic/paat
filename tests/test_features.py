...
def test_calculate_actigraph_counts(load_gt3x_file, test_root_path):
    ...
    counts_1s = features.calculate_actigraph_counts(data, sample_freq, "1s")
    ...
    counts_10s = features.calculate_actigraph_counts(data, sample_freq, "10s")
...
def test_calculate_brond_counts(load_gt3x_file):
    data, sample_freq = load_gt3x_file
    brond_counts = features.calculate_brond_counts(data, sample_freq, "10s")
